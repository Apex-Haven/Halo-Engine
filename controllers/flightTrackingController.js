...
const getUsageStats = async (req, res) => {
  try {
    const stats = flightTrackingService.getUsageStats();
    const cacheStats = flightTrackingService.getCacheStats();
...
const clearCache = async (req, res) => {
  try {
    const clearedCount = flightTrackingService.clearCache();
    ...
    res.json({
      ...
      message: `Successfully cleared ${clearedCount} cached entries`
    });
  } catch (error) {
